...
```
## Find Variables and View Data Frames
```{r}
...
countiesA1 <- inner_join(counties2018,counties_rural,by = "GEOID") %>% 
...
## Export CSV 
```{r}
write_csv(countiesA1,"countiesA1.csv")
countiesA1
```